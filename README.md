...
pixi add cuda-libraries-dev
# for installing globally
pixi global install cuda-libraries-dev
```
...
It is possible to list all of the versions of `cuda-libraries-dev` available on your platform:
...
```
pixi search cuda-libraries-dev --channel conda-forge
```
